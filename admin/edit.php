...
<body>
    ...
    <div class="portfolio_image_area">
        <div class="container">
             ...
             <div class="col-lg-8 col-md-8">
                        ...
                        <form action="upload.php" method="post">
                            <div class="mt-10">
                                <input type="text" name="name" placeholder="Project Name" value="<?php echo $prj['name']; ?>" 
                            ...
                            <div class="input-group-icon mt-10">
                                <div class="form-select" id="default-select"">
                                    ...
                                    <select name="category" >
                                        <option value="<?php echo $prj['category']; ?>"><?php echo $prj['category']; ?></option>
                            ...
                            <input type="hidden" name="id" value="<?php echo $prj['id']; ?>" >
                            <div class="mt-10">
                                <input type="text" name="client" placeholder="Client" value="<?php echo $prj['client']; ?>" 
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Client'" required
                                    class="single-input">
                            </div>

                            <div class="mt-10">
                                <input type="Date" name="date" placeholder="Date" value="<?php echo $prj['date']; ?>" 
                            ...
                            <div class="mt-10">
                                <textarea class="single-textarea" name="description"  placeholder="Project Description" onfocus="this.placeholder = ''"
                                    onblur="this.placeholder = 'Project Description' " " required><?php echo $prj['description']; ?>"</textarea>
                            </div>
                            
                            <div class="mt-10">
                                <input type="text" name="link" placeholder="Project Link" value="<?php echo $prj['link']; ?>" 
                            ...
                            <br>
                              ...
                              <div class="col-lg-12">
                                    <div class="submit_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                        <button class="boxed-btn3" type="submit" name="edi_project">Update</button>
                                    </div>
                                </div>
                        </form>
                    </div>
                        <?php   }  
                        elseif (!empty($_GET['pd'])) { 
                        $pd=$_GET['pd'];
                        $sql = "SELECT * FROM team where id='$pd'";
                        $team = $con->query($sql);
                        $tea = $team->fetch_assoc(); 
                        ...
                        <div class="bradcam_area breadcam_bg_2">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="bradcam_text">
                                            <h3>Update Team mate information</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
                        ...
                        <form action="upload.php" method="post">
                            <div class="mt-10">
                                <input type="text" name="name" placeholder="Full Name" value="<?php echo $tea['name']; ?>" 
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Name'" required
                                    class="single-input">
                            </div>
                            <input type="hidden" name="tid" value="<?php echo $tea['id']; ?>" >
                            <div class="input-group-icon mt-10">
                                <div class="form-select" id="default-select"">
                                            <select name="role" >
                                    <option value="<?php echo $tea['role']; ?>"><?php echo $tea['role']; ?></option>
                            ...
                            <div class="mt-10">
                                <input type="text" name="telegram" placeholder="Telegram" value="<?php echo $tea['telegram']; ?>" 
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Client'" required
                                    class="single-input">
                            </div>

                            <div class="mt-10">
                                <input type="text" name="linkedin" placeholder="Linkedin" value="<?php echo $tea['linkedin']; ?>" 
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Date'" required
                                    class="single-input">
                            </div>
                            ...
                            <div class="mt-10">
                                <input type="text" name="instagram" placeholder="instagram" value="<?php echo $tea['instagram']; ?>" 
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'instagram'" required
                                    class="single-input">
                            </div>
                            <br>
                              ...
                              <div class="col-lg-12">
                                    <div class="submit_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                        <button class="boxed-btn3" type="submit" name="eteam">Update</button>
                                    </div>
                                </div>
                        </form>
     </div>
     <?php } 
                                    ...
                                    $iid=$_GET['iid'];
                                    $sql = "SELECT * FROM pictures where id='$iid'";
                                    $pictures = $con->query($sql);
                                    $pic = $pictures->fetch_assoc(); 
                                    ...
                                    <div class="bradcam_area breadcam_bg_2">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="bradcam_text">
                                                        <h3>Update picture information</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div class="container">
                                    <div class="col-lg-8 col-md-8">
                                    <img style="display: inline-block; height: 50%; width: 150px;" src="<?php echo ".".$pic['path']; ?>">
                                    <h2 style=" font-weight: bold;" class="mb-30">Picture Information</h2>
                                    <form action="upload.php" method="post">
                                        <div class="mt-10">
                                            <input type="text" name="name" placeholder="Full Name" value="<?php echo $pic['filename']; ?>" 
                                                onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Name'" required
                                                class="single-input">
                                        </div>
                                        <input type="hidden" name="pid" value="<?php echo $pic['id']; ?>" >
                                        <div class="mt-10">
                                            <input type="text" name="path" placeholder="Telegram" value="<?php echo $pic['path']; ?>" 
                                                onfocus="this.placeholder = ''" onblur="this.placeholder = 'Client'" required
                                                class="single-input">
                                        </div>
                                        ...
                                        <br>
                                          ...
                                          <div class="col-lg-12">
                                                <div class="submit_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                                    <button class="boxed-btn3" type="submit" name="epic">Update</button>
                                                </div>
                                            </div>
                                    </form>
                 </div>
