        ...
        <div class="container">
            <div class="col-lg-8 col-md-8">
                        ...
                        <form>
                            ...
                            <div class="mt-10">
                                <input type="text" name="client" placeholder="Client" id="client"
                            ...
                            <div class="mt-10">
                                <textarea class="single-textarea" id="description" name="description" placeholder="Project Description" onfocus="this.placeholder = ''"
                                    onblur="this.placeholder = 'Project Description'" required></textarea>
                            </div>
                            
                            <div class="mt-10">
                                <input type="text" id="link" name="link" placeholder="Project Link"
                            ...
                            <br>
                              ...
                              <div class="col-lg-12">
                                    <div class="submit_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                        <button class="boxed-btn3" onclick="addProject()" type="button">Add</button>
                                    </div>
                                    <div id="validatorProject"></div>
                                </div>
                        </form>
                        <br>
                        <br>
         ...
         <div class="col-lg-8 col-md-8">
                        ...
                        <form action="upload.php" method="post">
                            <div class="mt-10">
                                <input type="text" name="name" placeholder="Full Name" id="tname"
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Name'" required
                                    class="single-input">
                            </div>
                            <div class="input-group-icon mt-10">
                                <div class="form-select" id="default-select">
                                            <select name="role" id="trole">
                            ...
                            <div class="mt-10">
                                <input type="text" name="telegram" placeholder="Telegram" id="ttelegram"
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Client'" required
                                    class="single-input">
                            </div>

                            <div class="mt-10">
                                <input type="text" name="linkedin" placeholder="Linkedin" id="tlinkedin"
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Date'" required
                                    class="single-input">
                            </div>
                            ...
                            <div class="mt-10">
                                <input type="text" name="twitter" placeholder="Twitter" id="ttwitter"
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Project Link'" required
                                    class="single-input">
                            </div>
                            <br>
                              ...
                              <div class="col-lg-12">
                                    <div class="submit_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                    <button class="boxed-btn3" onclick="addTeam()" type="button">Add</button>
                                   
                                    </div>
                                    <div id="validatorTeam"></div>
                                </div>
                        </form>
     </div></div>
