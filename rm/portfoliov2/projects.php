...
<html lang="en">
<head>
	<title>Jueve | Creative Agency HTML Template</title>
...
<body class="single-project" data-cookie="on" id="home" itemscope itemtype="http://schema.org/WebPage">
						...
						<article class="grid-item project hover-shrink featured branding product">
							<a href="single-project.html" class="project__url">
								<figure class="project__img-holder hover-shrink--shrink">
									<img src="s.png" class="project__img hover-shrink--zoom" alt="project 1">
								</figure>
							</a>
