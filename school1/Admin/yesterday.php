...
<head>
  <title>Habesha Tipster - Yesterday's Win's</title>
...
<body>
 ...
 <?php include 'include/sidebar.php';  ?>
      <div id="content">
        ...
        <h1>Choose Yesterday Wins</h1>
        <blockquote style="display: inline-block;"><span style="font-size: 18px; font-family: century gothic;">Remove all Yesterday wins</span></blockquote> <a href="yester.php"><button style="background-color: orange; font-family: century gothic;">Remove</button></a>
        <table style="width:100%; border-spacing:0;">
          ...
          <?php
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="yestr_up.php?post=<?php echo $row['s_id']?>">
